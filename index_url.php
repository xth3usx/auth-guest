...
// Gerar valores de nonce, state, code_verifier e code_challenge
$nonce = generateNonce();
$state = generateState();
...
// Construir a URL de autenticação do Gov.br (ambiente de testes), incluindo o code_verifier como parâmetro
$auth_url = AUTH_URL . '?response_type=code'
    ...
    . '&code_verifier_param=' . urlencode($code_verifier); // Adiciona o code_verifier como parâmetro extra
...
<body>
    <div class="container">
        ...
        <div class="logo">
            <img src="/images/logo.jpg" alt="Logo da Universidade">
        </div>
